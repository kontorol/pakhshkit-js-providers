import KontorolAsset from '../../../../src/k-provider/ott/response-types/kontorol-asset';

const mediaTypeConf = KontorolAsset.Type.MEDIA;
...
const FilteredSourcesByDeviceType = {
  ...
  sources: {
    ...
    metadata: {
      mediaType: KontorolAsset.Type.RECORDING,
      name: 'Trolls',
      metas: {
        'App Link': '',
        'Catchup allowed': false,
...
const LiveEntryNoDrm = {
  ...
  sources: {
    ...
    metadata: {
      mediaType: KontorolAsset.Type.EPG,
      name: 'USA',
      metas: {
        'App Link': '',
        'Catchup allowed': false,
